...
"""Agent-runnable consistency lint for d4np-c (generated by EAAO).
...
Generated configuration is in the CONFIG block below — EAAO fills it from project.yaml.
"""
...
# ---------------------------------------------------------------------------
# CONFIG — filled by EAAO at generation time from orchestrator/project.yaml.
# ---------------------------------------------------------------------------
CONFIG = {
    ...
    "version_file": "d4np/core/version.h",
