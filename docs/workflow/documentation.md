...
How documentation is maintained on `d4np-c`. Documentation is part of the
...
Public symbols are documented with `Doxygen`-compatible comments. The API-docs build
